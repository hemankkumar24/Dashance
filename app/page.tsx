  ...
  return (
    ...
    <div className='w-full bg-stone-50'>
      ...
      <div className='w-full px-5 lg:px-10 py-5 border-b-stone-500 border relative'>
        ...
        {/* Middle Name */}
        <div className="absolute inset-0 xl:flex items-start justify-center pt-5 main-font text-2xl pointer-events-none hidden">
          Dashance
        </div>
      </div>
      ...
      {/* Phone Section */}
      <div className='py-20 md:py-10 px-5 lg:px-10 flex justify-between items-center main-font w-full md:h-[60vh] border-b-stone-500 border-b'>
        <div className=''>
